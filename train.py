...
def train(data_folder,gt_folder,dataset_path='dataset',checkpoint='checkpoints',epochs=1,pretrain_flag=False,pretrain_model_weight_path=None,model_name='M32',gray_flag=True,block_size=(256,256),train_batch_size=1):
	...
	training_history = model.fit(my_training_batch_generator,epochs = epochs, verbose=1, workers = 21, use_multiprocessing = False,validation_data = my_validation_batch_generator,callbacks=callbacks_list)
